...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar com.varun.nw.CustomConsumer
```
...
```PowerShell
java -cp target/kafka-case-1.0-SNAPSHOT-jar-with-dependencies.jar com.varun.nw.CustomProducer
```
